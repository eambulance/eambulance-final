...
import 'package:x_hospitals/models/Details.dart';
...
class _RequestViewScreenState extends State<RequestViewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: patientRequest != null &&
              !patientRequest.isCompleted &&
              !patientRequest.status
          ? Row(
              ...
              children: [
                FloatingActionButton.extended(
                  ...
                  onPressed: () {
                    XDB().changeStatus(true, patientRequest.docId);
                  },
                  label: Text("Accept"),
                ...
                FloatingActionButton.extended(
                  ...
                  foregroundColor: Colors.white,
                  onPressed: () {
                    XDB().changeStatus(false, patientRequest.docId);
                  },
                  label: Text("Reject"),
